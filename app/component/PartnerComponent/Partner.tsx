        ...
        {partners.map((partner, index) => (
          ...
          >
            ...
            <Image
              src={partner.logo}
              alt={partner.name}
              width={120} // Adjust width based on your needs
              height={80} // Adjust height based on your needs
              className="w-44 h-20 md:w-44 sm:w-36 sm:h-24 md:h-28 lg:h-30 object-contain"
            />
          </div>
        ))}
      </div>
